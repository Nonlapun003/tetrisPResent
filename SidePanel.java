...
public class SidePanel extends JPanel {
	 ...
	 * The small font.
	 */
	private static final Font SMALL_FONT = new Font("Elephant", Font.BOLD, 11);
	
	/**
	 * The large font.
	 */
	private static final Font LARGE_FONT = new Font("Elephant", Font.BOLD, 11);
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("Total: " + tetris.getTotolscore(), LARGE_INSET, offset += TEXT_STRIDE);
		g.setFont(LARGE_FONT);
